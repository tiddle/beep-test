...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(_react2.default.createElement(Register, { url: '/api/signup' }), document.getElementById('content'));
	...
	var Register = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(RegisteredUsers, { users: this.state.data })
	        );
	    }
	});
